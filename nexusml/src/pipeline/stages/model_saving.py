...
from nexusml.src.pipeline.stages.base import BaseModelSavingStage
...
class ModelCardSavingStage(BaseModelSavingStage):
    ...
    def _create_model_card(
        ...
        model_name = kwargs.get(
            "model_name", self.config.get("model_name", "NexusML Model")
        )
        ...
        for col, metrics in evaluation_metrics.items():
            ...
            for metric, value in metrics.items():
                if (
                    ...
                    or metric == "confusion_matrix"
                    or metric == "class_metrics"
                ):
                    continue
                model_card += f"- **{metric}:** {value}\n"
            model_card += "\n"
