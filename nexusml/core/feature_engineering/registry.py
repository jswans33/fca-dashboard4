...
from nexusml.core.feature_engineering.interfaces import FeatureTransformer, TransformerRegistry
...
class DefaultTransformerRegistry(TransformerRegistry):
    ...
    def register_transformer(self, name: str, transformer_class: Type[FeatureTransformer]) -> None:
        ...
        if not issubclass(transformer_class, FeatureTransformer):
            raise ValueError(f"Class '{transformer_class.__name__}' is not a FeatureTransformer")
