...
from nexusml.core.model_building.interfaces import ModelTrainer
from nexusml.core.pipeline.context import PipelineContext
from nexusml.core.pipeline.stages.base import BaseModelTrainingStage
...
class StandardModelTrainingStage(BaseModelTrainingStage):
    ...
    def validate_context(self, context: PipelineContext) -> bool:
        ...
        return (
            context.has("model")
            and context.has("x_train")
            and context.has("y_train")
        )
