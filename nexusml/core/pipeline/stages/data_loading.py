...
from nexusml.core.pipeline.stages.base import BaseDataLoadingStage
...
class ConfigurableDataLoadingStage(BaseDataLoadingStage):
    ...
    def __init__(
        ...
        self._loaders = {
            ...
            "excel": ExcelDataLoadingStage(config=config, config_manager=config_manager),
            "sqlite": SQLiteDataLoadingStage(config=config, config_manager=config_manager),
        }
