...
from nexusml.core.model_building.interfaces import ModelBuilder
from nexusml.core.pipeline.context import PipelineContext
from nexusml.core.pipeline.stages.base import BaseModelBuildingStage
            ...
            [
                ("preprocessor", ColumnTransformer(
                    transformers=[
                        ...
                        ("numeric", StandardScaler(), ["service_life", "CategoryID", "OmniClassID", "UniFormatID", "MasterFormatID"]),
                        # Use categorical columns for one-hot encoding
                        ("categorical", OneHotEncoder(handle_unknown='ignore'), ["equipment_tag", "manufacturer", "model"]),
                    ],
