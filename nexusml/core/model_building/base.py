...
class BaseConfigurableModelBuilder(BaseModelBuilder, ConfigurableModelBuilder):
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self._config_provider, "config") and hasattr(self._config_provider.config, "model"):
...
class BaseConfigurableModelTrainer(BaseModelTrainer, ConfigurableModelTrainer):
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self._config_provider, "config") and hasattr(self._config_provider.config, "training"):
...
class BaseHyperparameterOptimizer(HyperparameterOptimizer):
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self._config_provider, "config") and hasattr(self._config_provider.config, "hyperparameter_optimization"):
                hp_config = self._config_provider.config.hyperparameter_optimization.model_dump()
                logger.info("Loaded hyperparameter optimization configuration from provider")
                return hp_config
        except Exception as e:
            logger.warning(f"Could not load hyperparameter optimization configuration from provider: {e}")
...
class BaseModelEvaluator(ModelEvaluator):
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self._config_provider, "config") and hasattr(self._config_provider.config, "evaluation"):
                eval_config = self._config_provider.config.evaluation.model_dump()
                logger.info("Loaded evaluation configuration from provider")
                return eval_config
        except Exception as e:
            logger.warning(f"Could not load evaluation configuration from provider: {e}")
    ...
    def evaluate(
        ...
        try:
            ...
            # Add overall metrics
            metrics["overall"] = {
                "accuracy_mean": np.mean([metrics[col]["accuracy"] for col in y_test.columns]),
                "f1_macro_mean": np.mean([metrics[col]["f1_macro"] for col in y_test.columns]),
            }
...
class BaseModelSerializer(ModelSerializer):
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self._config_provider, "config") and hasattr(self._config_provider.config, "serialization"):
            ...
            logger.warning(f"Could not load serialization configuration from provider: {e}")
