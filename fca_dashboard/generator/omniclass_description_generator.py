...
DEFAULT_INPUT_FILE = config.get('input_file', 'fca_dashboard/generator/ingest/omniclass.csv')
DEFAULT_OUTPUT_FILE = config.get('output_file', 'fca_dashboard/generator/ingest/omniclass_with_descriptions.csv')
...
class AnthropicClient(ApiClient):
    ...
    def call(self, prompt: str, system_prompt: str, model: str = MODEL, 
...
class BatchProcessor:
    ...
    def process(self, df: pd.DataFrame, description_column: str = 'Description',
...
def main():
    ...
    parser.add_argument('--input', type=str, default=DEFAULT_INPUT_FILE, help=f'Path to the input CSV file (default: {DEFAULT_INPUT_FILE})')
    parser.add_argument('--output', type=str, default=DEFAULT_OUTPUT_FILE, help=f'Path to the output CSV file (default: {DEFAULT_OUTPUT_FILE})')
    ...
    parser.add_argument('--description-column', type=str, default=DEFAULT_DESCRIPTION_COLUMN, help=f'Column to store descriptions in (default: {DEFAULT_DESCRIPTION_COLUMN})')
