...
class TestComponentRegistry(unittest.TestCase):
    ...
    def test_register_different_component_types(self):
        ...
        self.registry.register(DataPreprocessor, "mock_preprocessor", MockDataPreprocessor)

        # Verify they were registered
        loader_implementations = self.registry.get_implementations(DataLoader)
        preprocessor_implementations = self.registry.get_implementations(DataPreprocessor)
